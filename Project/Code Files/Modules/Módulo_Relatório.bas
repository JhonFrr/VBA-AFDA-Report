...
'DESATIVANDO RECURSOS PARA OTIMIZACAO <<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<
Application.ScreenUpdating = False 'Desabilita atualização de tela
Application.Calculation = xlManual 'Desabilita o calculo automatico
...
Application.ScreenUpdating = True 'Reabilita atualização de tela
